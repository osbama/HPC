...
This page contains some tips on how to get started using the Dilhan cluster 
if you are not too familiar with Linux/ Unix. The information is intended
for both users that are new to Dilhan and for users that are new to 
...
For details about the hardware and the operating system of Dilhan, and basic
explanation of Linux clusters please see the :ref:`about_dilhan` part of this
documentation.

To find out more about the storage and file systems on the machines, your disk
quota, how to manage data, and how to transfer file to/from Dilhan, please read
...
The only way to connect to Dilhan is by using ssh. Check
