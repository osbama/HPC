...
In addition to standard gcc compiler suite provided by the CentOs, Dilhan has 
...
You need to load appropiate intel compiler module (i.e. ``module load compilers/intel/20.2``).
...
Please note that NVHPC compilers come with their own openmpi. If you want to disable it, or override it with the Dilhan provided openmpi, load the corresponding modules.
