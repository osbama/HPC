...
Here you will get the basics to work with Dilhan. Please study carefully the links at the end of each paragraph to get more detailed information.
...
You may connect to Dilhan via *SSH* to ``144.122.31.1``. This means that on Linux and OSX you may directly connect by opening a terminal and writing ``ssh username@144.122.31.1``. From Windows, you may connect via PuTTY which is available in the Software Center. X-forwarding for graphical applications is possible. There exists also a webinterface to allow easy graphical login. Please see the following link for details to all mentioned methods. :doc:`/account/login`
...
You will also be in your home directory ``/home/username``. Here, you have 300 GB at your disposal. This space is not backed up. Please remove old files regularly. :doc:`/storage/storage`
