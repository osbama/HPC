...
About the VASP version(s) installed on Dilhan
---------------------------------------------

Since the installation we made on Dilhan is rather tailor made, we have gathered information about this here: :doc:`vasp_on_dilhan`.
